...
CREATE SEQUENCE IF NOT EXISTS public.payment_system_id_seq START WITH 1 INCREMENT BY 1;

CREATE TABLE public.group_fund_transaction
(
...
ALTER TABLE public.group_fund_transaction
