    ...
    import com.wowo.wowo.builder.GroupFundBuilder;
    ...
    public class GroupFundService {
        ...
        public GroupFund createGroupFund(GroupFundDTO groupFundDTO, Authentication authentication) {
            ...
            GroupFund groupFund = new GroupFundBuilder()
                    .setName(groupFundDTO.getName())
                    .setImage(groupFundDTO.getImage())
                    .setType(groupFundDTO.getType())
                    .setDescription(groupFundDTO.getDescription())
                    .setTarget(groupFundDTO.getTarget())
                    .setTargetDate(groupFundDTO.getTargetDate())
                    .setOwner(ownerUser)
                    .build();

            try {
                // Lưu GroupFund vào cơ sở dữ liệu
                GroupFund savedGroupFund = groupFundRepository.save(groupFund);

                // Tạo và lưu FundMember cho owner
        ...
        private void validateGroupFundData(GroupFundDTO groupFundDTO) {
            ...
            if (groupFundDTO.getTarget() == null) {
